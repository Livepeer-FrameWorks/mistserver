...
bool interactiveFirstTimeSetup(const std::string &setupUrl){
  std::cout << std::endl
            << "Initial setup is available through the web interface at " << setupUrl
            << " or through this console."
            << std::endl;
...
int main_loop(int argc, char **argv){
  ...
  Controller::conf.addOption("prometheus", R"-({
    ...
    "arg":"string"
    "default":"metrics",
    "help":"Subpath for Prometheus-style stats over the API port. Set to empty string to disable."
  })-");
