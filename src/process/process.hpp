...
void addGenericProcessOptions(JSON::Value & capa){
  ...
  capa["optional"]["general_process_options"]["name"] = "Generic process options";
  capa["optional"]["general_process_options"]["type"] = "group";
  capa["optional"]["general_process_options"]["expand"] = true;
  capa["optional"]["general_process_options"]["sort"] = "zzzz";
  {
    ...
    genopts["start_control"]["expand"] = true;
    genopts["start_control"]["sort"] = "zzzz";
    {
      ...
      grp["restart_type"]["help"] = "What to do when the process exits or fails for any reason. Fixed waits the "
                                    "restart delay every time. Exponential backoff will increase the delay up to max "
                                    "the configured delay for each restart. Disabled will not restart the process.";
