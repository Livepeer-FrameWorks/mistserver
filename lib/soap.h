...
namespace SOAP {
  ...
  constexpr const char *WSS_PASSWORD_TYPE =
    "http://docs.oasis-open.org/wss/2004/01/"
    "oasis-200401-wss-username-token-profile-1.0#PasswordDigest";
  constexpr const char *WSS_ENCODING_TYPE =
    "http://docs.oasis-open.org/wss/2004/01/"
  ...
  class Message {
    public:
       ...
       * @param mustUnderstand Whether the header must be understood (defaults to true)
       */
      void addWSATo(const std::string & uri, bool mustUnderstand = true) {
        addHeader("wsa:To", uri, mustUnderstand);
      }
    ...
    private:
      ...
      std::string getEnvelopeTag() const {
        return version == Version::SOAP_1_2 ? "s:Envelope" : "SOAP-ENV:Envelope";
      }

      std::string getHeaderTag() const {
        return version == Version::SOAP_1_2 ? "s:Header" : "SOAP-ENV:Header";
      }

      std::string getBodyTag() const {
        return version == Version::SOAP_1_2 ? "s:Body" : "SOAP-ENV:Body";
      }

      std::string getFaultTag() const {
        return version == Version::SOAP_1_2 ? "s:Fault" : "SOAP-ENV:Fault";
      }
  ...
  namespace onvif {
    ...
    class DiscoveryFactory {
      ...
      private:
         ...
         */
        void createDiscoveryBody(Message & msg, const DiscoveryOptions & options,
    ...
    Message makeDiscoveryProbe(const std::string & types = "dn:NetworkVideoTransmitter",
                               Version version = Version::SOAP_1_2);
