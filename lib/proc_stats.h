...
class ProcExitState {
  ...
  public:
    ...
    /// Also calls Util::logExitReason for the process-local log message. Callers that
    /// want to preserve a lower-layer reason pass Util::mRExitReason/exitReason here.
