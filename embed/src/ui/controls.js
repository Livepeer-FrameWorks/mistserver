...
export function MistUI(MistVideo,structure) {
  MistVideo.UI = this;
  this.elements = [];
  ...
  //apply design tokens as CSS custom properties on the container
  MistUtil.css.applyCustomProperties(container, MistVideo.skin.colors, MistVideo.skin.tokens);
