...
registerTab('Login', function(tab, other, prev, $main) {
  ...
  UI.elements.connection.status.textContent = tr('Disconnected');
...
registerTab('Create a new account', function(tab, other, prev, $main) {
  ...
  const subtitle = el('span', {}, tr('No account has been created yet at '));
  ...
  const altHostBtn = el('button', {class: 'login-alt-host'}, tr('Select other host'));
